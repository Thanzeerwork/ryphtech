      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            <button
              onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
              className="h-14 w-14 shrink-0 border border-foreground/10 rounded-full flex items-center justify-center text-foreground/70 hover:text-foreground transition-colors"
              aria-label="Toggle theme"
            >
              {mounted && (theme === "dark" ? (
