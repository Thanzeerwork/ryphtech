...
const words = ["digital reality", "innovation", "success", "excellence"];
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40 w-full">
        ...
        <div className="mb-12">
          <h1
            className={`text-[clamp(2.75rem,9vw,8rem)] font-display leading-[0.95] tracking-tight transition-all duration-1000 ${
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
          ...
          >
            RyphTech delivers cutting-edge web development, mobile apps, and AI solutions that
